  ...
  return (
    <div className="cardWrapper">
      <div className="card">
        ...
        {/* WhatsApp 1 - Prakyat Shetty */}
        <div className="cardItem">
          <a href="https://wa.me/+918660841074" className="socialContainer containerWhatsapp" aria-label="WhatsApp: Prakyat Shetty">
          ...
          <div className="contactName">Prakyat Shetty</div>
        </div>
